...
const designs = [
    ...
    {id: "entry5", 
    name: "Design Log 5: Second to last Wireframes and Colour Blockouts.", 
    href: `${root}designs/log5.html`, 
    summary: "Here are my design sketches in the form of wireframes and colour blockouts for my second to last website."},
    {id: "entry6", 
