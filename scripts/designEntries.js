...
const designs = [
    {id: "entry1", 
    name: "Design 1: Goal Alignment, Information Structure and User Flow.", 
    href: `${root}designs/log1.html`, 
    summary: "In this log I speak about my goal alignment, my information structure and my user flow."},
    {id: "entry2", 
    name: "Design 2: Inspirations, Visual Aesthetics and Visual Elements.", 
